...
namespace PS2GradingTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        /**************** PERSONAL TESTS *************************************/
        /// <summary>
        /// Test replacment of a dependee that doesn't exist
        /// </summary>
        [TestMethod()]
        public void ReplaceNonExistDependee()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("a", "c");
            t.AddDependency("d", "c");
            t.ReplaceDependees("e", new HashSet<string>() { "x", "y", "z" });
            HashSet<String> cDees = new HashSet<string>(t.GetDependees("e"));
            Assert.IsTrue(cDees.SetEquals(new HashSet<string>() { "x", "y", "z" }));
        }

        /// <summary>
        /// Test replacement of a dependent that doesn't exist
        /// </summary>
        [TestMethod()]
        ...
        /// <summary>
        /// Test replacing dependees with existing dependees
        /// </summary>
        [TestMethod()]
        ...
        /// <summary>
        /// Test replacing dependents with existing dependents
        /// </summary>
        [TestMethod()]
